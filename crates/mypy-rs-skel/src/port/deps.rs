//! Standalone driver glue: deps.
//!
//! Module dependency records and incremental state for the standalone
//! driver.
//!
//! Contract (wave 1, docs/plans/2026-09-24-standalone-full-port-
//! wave1.md): this module is the skeleton-side caller of
//! `type_kernel::standalone::deps`. It owns no checking logic of its own:
