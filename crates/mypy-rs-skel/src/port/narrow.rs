//! Standalone driver glue: narrow.
//!
//! Drive narrowing in the skeleton binder: if/isinstance/comparison
//! branches.
//!
//! Contract (wave 1, docs/plans/2026-09-24-standalone-full-port-
//! wave1.md): this module is the skeleton-side caller of
//! `type_kernel::standalone::narrow`. It owns no checking logic of its
