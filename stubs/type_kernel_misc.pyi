...
# WirePhaseCounters10 in crates/type_kernel/src/wire.rs: (mode, decode_calls,
# decode_bytes, decode_nodes, encode_calls, encode_bytes, encode_nodes,
# clone_nodes, hash_bytes, hash_ops).
def rust_wire_phase_counters() -> (
    tuple[int, int, int, int, int, int, int, int, int, int]
): ...
def rust_wire_phase_set_mode(mode: int) -> int: ...
def rust_wire_phase_reset() -> None: ...
